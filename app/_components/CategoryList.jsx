...
function CategoryList() {
  ...
  return (
    <div className="mt-20 pt-5 relative">
        ...
        {categoryList &&
          categoryList.map((category, index) => (
            <Link
              ...
              key={index}
              className={`flex flex-col items-center gap-2 border p-3 rounded-lg min-w-28
      ...
      <ArrowRightCircle
        className="absolute -right-10 top-9 bg-gray-500 rounded-full text-white
